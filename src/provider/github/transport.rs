...
pub(super) async fn token(host: Option<&str>) -> Option<Arc<str>> {
...
pub(super) fn check(response: &mut Response<Body>, what: &str) -> Result<()> {
...
pub(super) async fn write_token(repo: &Repo) -> Result<Arc<str>> {
