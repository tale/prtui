...
use prtui_core::{ChangedFile, DiffLine, LineKind, parse_hunk_header};
...
/// The declaration after the second `@@`, kept as it came.
...
mod tests {
    ...
    fn file() -> ChangedFile {
        let line = |kind: LineKind,
                    text: &str,
                    old_line: Option<u32>,
                    new_line: Option<u32>| DiffLine {
            kind,
            text: text.into(),
            old_line,
            new_line,
        ...
        ChangedFile {
            ...
            deletions: 0,
            lines: vec![
                line(LineKind::Hunk, "@@ -10,3 +10,4 @@ fn ten()", None, None),
                line(LineKind::Context, "line 10", Some(10), Some(10)),
                line(LineKind::Context, "line 11", Some(11), Some(11)),
                line(LineKind::Added, "added", None, Some(12)),
                line(LineKind::Context, "line 12", Some(12), Some(13)),
                line(
                    LineKind::Hunk,
                    "@@ -30,2 +31,2 @@ fn thirty()",
                    None,
                ...
                line(LineKind::Context, "line 30", Some(30), Some(31)),
                line(LineKind::Context, "line 31", Some(31), Some(32)),
            ],
        }
    }
    ...
    /// A patch with nothing in it describes no file, so there is nothing to
    /// expand into.
    #[test]
